...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url("app-assets/vendors/noUiSlider/nouislider.min.css")?>">
    <!-- END: VENDOR CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url("app-assets/css/pages/eCommerce-products-page.css")?>">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
          ...
          <div class="nav-wrapper">
            ...
            <ul class="dropdown-content" id="profile-dropdown">
              ...
              $id =$session->get('user_id');
                        if(isset($id)){   ?>
              <li><a class="grey-text text-darken-1" href="<?=base_url("Produit/edit")?>"><i class="material-icons">chat_bubble_outline</i> Ajouter un produit</a></li>
              <li><a class="grey-text text-darken-1" href="<?=base_url("Produit/")?>"><i class="material-icons">help_outline</i> Mes produits</a></li>
              <li class="divider"></li>
           
              <li><a class="grey-text text-darken-1" href="<?=base_url("Login/logout")?>"><i class="material-icons">keyboard_tab</i> Logout</a></li>
              <?php }else{?>

                  <li><a class="grey-text text-darken-1" href="<?=base_url("Login/")?>"><i class="material-icons">person_outline</i> Singn</a></li>
