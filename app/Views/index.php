        ...
        <div class="row">
            ...
            <div class="container">
                ...
                <div class="col s10 m6 l6">
                    ...
                    <li class="breadcrumb-item"><a href="<?=base_url("/home/index")?>">Home</a>
                    </li>
        ...
        <div class="col s12 m3 l3 pr-0 hide-on-med-and-down animate fadeLeft">
            <div class="card">
                ...
                <ul class="collapsible categories-collapsible">
                    <li>
                    <div class="collapsible-header">Selectionnez une categorie <i class="material-icons"> keyboard_arrow_right </i></div>
